  ...
  describe("parseOpggUrl", () => {
    ...
    it("日本語サモナー名をデコード", () => {
      ...
      expect(result).toEqual({
        ...
        region: "jp",
        cleanedUrl:
          "https://op.gg/summoners/jp/%E3%83%86%E3%82%B9%E3%83%88-JP1",
      });
    });

    it("日本語タグラインをデコード", () => {
      const url =
        "https://www.op.gg/summoners/jp/TestPlayer-%E3%83%86%E3%82%B9%E3%83%88";
      const result = parseOpggUrl(url);
      ...
      expect(result).toEqual({
        ...
        region: "jp",
        cleanedUrl:
          "https://op.gg/summoners/jp/TestPlayer-%E3%83%86%E3%82%B9%E3%83%88",
      });
    });
    ...
    it("日本語URLを解析", () => {
      ...
      expect(result).toEqual({
        ...
        region: "jp",
        cleanedUrl:
          "https://op.gg/summoners/jp/%E3%83%86%E3%82%B9%E3%83%88-%E3%83%86%E3%82%B9%E3%83%88",
      });
    });
  ...
  describe("buildOpggUrl", () => {
    ...
    it("日本語名をエンコード", () => {
      ...
      expect(url).toContain(
        `${encodeURIComponent("テストプレイヤー")}-${encodeURIComponent("テストタグ")}`,
      );
    });
    ...
    it("スペースを含む名前をエンコード", () => {
      ...
      expect(url).toContain(
        `Test%20Player-${encodeURIComponent("テスト タグ")}`,
      );
    });
