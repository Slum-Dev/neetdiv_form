...
describe('FormSubmissionHandler', () => {
  ...
  describe('handle', () => {
    it('正常なフォーム送信を処理できる', async () => {
      ...
      mockSpreadsheet.setCellValue(10, 8, 'https://www.op.gg/summoners/jp/TestPlayer-JP1');
    ...
    it('レベル30未満のサモナーはランク情報を取得しない', async () => {
      // Arrange
      mockSpreadsheet.lastRow = 10;
      mockSpreadsheet.setCellValue(10, 8, 'https://www.op.gg/summoners/jp/NewPlayer-JP1');
    ...
    it('アンランクのサモナーを適切に処理', async () => {
      // Arrange
      mockSpreadsheet.lastRow = 10;
      mockSpreadsheet.setCellValue(10, 8, 'https://www.op.gg/summoners/jp/UnrankedPlayer-JP1');
